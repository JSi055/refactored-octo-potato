...
typedef struct Noritake_VFD_CUU_struct {
	...
	void setDisplay(Noritake_VFD_CUU* vfd);	// Set display according to display/cursor/blink members
	void setDirection(Noritake_VFD_CUU* vfd);	// Set text direction based on rightToLeft/autoscroll
	void printNumber_long(Noritake_VFD_CUU* vfd, long number, int base);
	void printNumber_ulong(Noritake_VFD_CUU* vfd, unsigned long number, int base);
	void nextLine(Noritake_VFD_CUU* vfd);
	
	//public:
    
    void begin(Noritake_VFD_CUU* vfd, int cols, int lines);
    void interface(Noritake_VFD_CUU* vfd, CUU_Interface* interface);
    void brightnessBoost(Noritake_VFD_CUU* vfd);
    void cu20045_uw4j(Noritake_VFD_CUU* vfd);
    
    void bcVFD(Noritake_VFD_CUU* vfd);
    void japaneseFont(Noritake_VFD_CUU* vfd);
    void europeanFont(Noritake_VFD_CUU* vfd);
	...
	void CUU_print_int(Noritake_VFD_CUU* vfd, int number, int base);
	void CUU_print_uint(Noritake_VFD_CUU* vfd, unsigned int number, int base);
	void CUU_print_long(Noritake_VFD_CUU* vfd, long number, int base);
	void CUU_print_ulong(Noritake_VFD_CUU* vfd, unsigned long number, int base);
	...
	void CUU_println_int(Noritake_VFD_CUU* vfd, int number, int base);
	void CUU_println_uint(Noritake_VFD_CUU* vfd, unsigned int number, int base);
	void CUU_println_long(Noritake_VFD_CUU* vfd, long number, int base);
	void CUU_println_ulong(Noritake_VFD_CUU* vfd, unsigned long number, int base);
