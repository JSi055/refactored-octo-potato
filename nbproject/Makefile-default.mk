...
${OBJECTDIR}/Input_handler_Functions.o: Input_handler_Functions.c  .generated_files/flags/default/8cd8ed4865831e03edfad484b707a80d8cb77c3d .generated_files/flags/default/ab79f85e8b884ca16bf55aa7d0cf27f9007bd660
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Input_handler_Functions.o.d 
	@${RM} ${OBJECTDIR}/Input_handler_Functions.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Input_handler_Functions.c  -o ${OBJECTDIR}/Input_handler_Functions.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/Input_handler_Functions.o.d"      -g -D__DEBUG     -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -O2 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
...
${OBJECTDIR}/Input_handler_Functions.o: Input_handler_Functions.c  .generated_files/flags/default/626840b10dfaddee927584c0616ea7d5703f56be .generated_files/flags/default/ab79f85e8b884ca16bf55aa7d0cf27f9007bd660
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Input_handler_Functions.o.d 
	@${RM} ${OBJECTDIR}/Input_handler_Functions.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Input_handler_Functions.c  -o ${OBJECTDIR}/Input_handler_Functions.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/Input_handler_Functions.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -O2 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
